...
class IndexAction extends CommonAction {
    ...
    {
        $works_model=D('Works');
        $works  = $works_model->query("SELECT w.*,u.nickname FROM xiami_works as w left join xiami_user as u on u.id=w.userid  WHERE w.STATUS =2 ORDER BY w.addtime DESC , w.is_top LIMIT 6"); 
